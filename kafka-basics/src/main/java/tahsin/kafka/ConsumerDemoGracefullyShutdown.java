...
public class ConsumerDemoGracefullyShutdown {

    private static final Logger log = LoggerFactory.getLogger(ConsumerDemoGracefullyShutdown.class.getName());

    public static void main(String[] args) throws Exception {

        final String groupId = "kafka-application.two";
