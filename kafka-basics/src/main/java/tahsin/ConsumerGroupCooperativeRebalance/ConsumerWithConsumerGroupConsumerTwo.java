...
public class ConsumerWithConsumerGroupConsumerTwo {

    private static final Logger log = LoggerFactory.getLogger(ConsumerWithConsumerGroupConsumerTwo.class.getName());
