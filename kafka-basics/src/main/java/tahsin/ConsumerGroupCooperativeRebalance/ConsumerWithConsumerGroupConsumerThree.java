package tahsin.ConsumerGroupCooperativeRebalance;
...
public class ConsumerWithConsumerGroupConsumerThree {

    private static final Logger log = LoggerFactory.getLogger(ConsumerWithConsumerGroupConsumerThree.class.getName());

    public static void main(String[] args) throws Exception {

        final String groupId = "kafka-application.four";
